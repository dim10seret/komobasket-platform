...
import { useCanonicalTeamLogos } from "./CanonicalTeamLogoContext";

export default function TeamsGrid({ archiveSeason }: { archiveSeason?: string } = {}) {
  const logos = useCanonicalTeamLogos();
