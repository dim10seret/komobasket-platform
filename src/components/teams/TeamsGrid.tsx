...
export default function TeamsGrid() {
  ...
  return <section className="bg-zinc-100 py-10"><div className="mx-auto max-w-7xl px-6">
    <div className="mb-8 rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm"><label className="mb-2 block text-sm font-bold text-zinc-700">Σεζόν</label><select value={season} onChange={(event) => setSeason(event.target.value)} className="w-48 rounded-xl border border-zinc-300 bg-white px-4 py-3"><option>2025-26</option><option>2024-25</option><option>2023-24</option><option>2022-23</option><option>2021-22</option><option>2020-21</option><option>2019-20</option></select></div>
