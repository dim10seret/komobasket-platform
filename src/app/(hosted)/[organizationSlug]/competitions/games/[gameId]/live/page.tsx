...
export default async function HostedLiveGamePage({ params }: Props) {
  ...
  return <HostedOrganizationPublicShell organization={organization}><HostedOrganizationHero compact eyebrow={`${organization.name} Live`} title="Ζωντανή εξέλιξη αγώνα" />{result.kind === "game"
