        ...
        <section className="bg-zinc-950 py-20 text-white">
          <div className="mx-auto max-w-7xl px-6 text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-zinc-300">
              Συμπληρώστε τη φόρμα και στείλτε το μήνυμά σας στην οργανωτική επιτροπή του KomoBasket.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-3xl px-6 py-16">
          <form onSubmit={handleSubmit} className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-lg md:p-10">
            ...
            <p className="mt-4 text-center text-sm leading-6 text-zinc-500">
              Το μήνυμα αποστέλλεται με ασφάλεια στην οργανωτική επιτροπή του KomoBasket.
            </p>
            {status && (
