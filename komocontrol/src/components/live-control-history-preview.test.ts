...
const gameplay = {
    runId: "run", gameMode: "FULL", lifecycle: "live", eventHistoryRevision: 1, lastAcceptedSequence: 1, score: { home: 0, away: 0 }, period: { kind: "REGULATION", index: 1 }, periodScores: [{ period: { kind: "REGULATION", index: 1 }, home: 0, away: 0 }], clockSeconds: 500, clockRunning: false, clockStartedAtMs: null, possession: null, alternatingPossession: "AWAY", finished: false, latestEvent: null,
    rules: { startingPlayers: 5, regulationPeriods: 4, regulationPeriodSeconds: 600, overtimeSeconds: 300, resultPolicy: "REQUIRE_WINNER" },
    teams: [
        { side: "HOME", presentationSide: "RIGHT", teamId: "h", teamName: "HOME TEAM", gameColor: "#dc2626", score: 0, timeouts: 0, timeoutAllowance: 2, teamFouls: 0, inBonus: false, nextDefensivePersonalFoulCreatesPenalty: false, discipline: { headCoachCategory1TechnicalCount: 0, benchCategory1TechnicalCount: 0, headCoachDisqualified: false, disqualifiedBenchCount: 0 }, captainPlayerId: null, starterPlayerIds: [], players: [player("h5", "5"), player("h12", "12")], bench: [{ personId: "coach:HOME", displayName: "HOME COACH", role: "HEAD_COACH", roleLabel: "Coach", source: "RUN" }], statistics: {} },
        { side: "AWAY", presentationSide: "LEFT", teamId: "a", teamName: "AWAY TEAM", gameColor: "#15803d", score: 0, timeouts: 0, timeoutAllowance: 2, teamFouls: 0, inBonus: false, nextDefensivePersonalFoulCreatesPenalty: false, discipline: { headCoachCategory1TechnicalCount: 0, benchCategory1TechnicalCount: 0, headCoachDisqualified: false, disqualifiedBenchCount: 0 }, captainPlayerId: null, starterPlayerIds: [], players: [player("a7", "7"), player("a8", "8")], bench: [{ personId: "bench:AWAY", displayName: "AWAY BENCH", role: "ACCOMPANYING_DELEGATION", roleLabel: "Bench", source: "RUN" }], statistics: {} },
